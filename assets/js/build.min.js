 ...
 * @license
*/
function(e){var t,n;!function(){var e,t,n,i,o,r,s,a,l,c,u,d,p,h,f,g,m,v,y,b,w,x,_,k,T,S,C,E=function(e){var t=new E.Builder;return t.pipeline.add(E.trimmer,E.stopWordFilter,E.stemmer),t.searchPipeline.add(E.stemmer),e.call(t,t),t.build()};E.version="2.1.5"
/*!
 * lunr.utils
 ...
 */,E.stemmer=(e={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},t={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},n="[aeiouy]",i="[^aeiou][^aeiouy]*",o=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),r=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),s=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$"),a=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"),l=/^(.+?)(ss|i)es$/,c=/^(.+?)([^s])s$/,u=/^(.+?)eed$/,d=/^(.+?)(ed|ing)$/,p=/.$/,h=/(at|bl|iz)$/,f=new RegExp("([^aeiouylsz])\\1$"),g=new RegExp("^"+i+n+"[^aeiouwxy]$"),m=/^(.+?[^aeiou])y$/,v=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,y=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,b=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,w=/^(.+?)(s|t)(ion)$/,x=/^(.+?)e$/,_=/ll$/,k=new RegExp("^"+i+n+"[^aeiouwxy]$"),T=function(n){var i,T,S,C,E,A,O;if(n.length<3)return n;if("y"==(S=n.substr(0,1))&&(n=S.toUpperCase()+n.substr(1)),E=c,(C=l).test(n)?n=n.replace(C,"$1$2"):E.test(n)&&(n=n.replace(E,"$1$2")),E=d,(C=u).test(n)){var L=C.exec(n);(C=o).test(L[1])&&(C=p,n=n.replace(C,""))}else E.test(n)&&(i=(L=E.exec(n))[1],(E=a).test(i)&&(A=f,O=g,(E=h).test(n=i)?n+="e":A.test(n)?(C=p,n=n.replace(C,"")):O.test(n)&&(n+="e")));return(C=m).test(n)&&(n=(i=(L=C.exec(n))[1])+"i"),(C=v).test(n)&&(i=(L=C.exec(n))[1],T=L[2],(C=o).test(i)&&(n=i+e[T])),(C=y).test(n)&&(i=(L=C.exec(n))[1],T=L[2],(C=o).test(i)&&(n=i+t[T])),E=w,(C=b).test(n)?(i=(L=C.exec(n))[1],(C=r).test(i)&&(n=i)):E.test(n)&&(i=(L=E.exec(n))[1]+L[2],(E=r).test(i)&&(n=i)),(C=x).test(n)&&(i=(L=C.exec(n))[1],E=s,A=k,((C=r).test(i)||E.test(i)&&!A.test(i))&&(n=i)),E=r,(C=_).test(n)&&E.test(n)&&(C=p,n=n.replace(C,"")),"y"==S&&(n=S.toLowerCase()+n.substr(1)),n},function(e){return e.update(T)}),E.Pipeline.registerFunction(E.stemmer,"stemmer")
/*!
 * lunr.stopWordFilter
 * Copyright (C) 2017 Oliver Nightingale
